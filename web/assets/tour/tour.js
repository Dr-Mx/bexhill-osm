	...
	setTimeout(function () {
		switch (tourName) {
			...
			case 'railwayWestbranch':
				map.setZoom(15);
				imageOverlay = L.imageOverlay('assets/tour/tour4/westbranchline.png', [[50.8860, 0.4625], [50.8400, 0.5100]], { opacity: 0.9 }).addTo(map);
				break;
			...
			case 'tramway':
				map.setZoom(15);
				imageOverlay = L.imageOverlay('assets/tour/tour5/tramway.png', [[50.8523, 0.4268], [50.8324, 0.5343]], { opacity: 0.9 }).addTo(map);
				break;
			case 'motorTrack':
				map.flyTo([50.83958, 0.48503], 17);
				imageOverlay = L.imageOverlay('assets/tour/tour6/racetrack.png', [[50.84135, 0.47991], [50.83772, 0.49508]], { opacity: 0.9 }).addTo(map);
				break;
				case 'motorSerpollet':
				rLookup = true;
