...
# /usr/bin/wget -O /home/bexhillo/public_html/assets/img/info-twitter.svg "https://img.shields.io/static/v1?logo=twitter&logoColor=%231da1f2&labelColor=rgba(0,0,0,0.4)&color=%231da1f2&label=Twitter&style=flat&message=285"
# YouTube
...
# /usr/bin/wget -O /home/bexhillo/public_html/assets/img/info-youtube.svg "https://img.shields.io/static/v1?logo=youtube&logoColor=%23ff0000&labelColor=rgba(0,0,0,0.4)&label=YouTube&color=%23ff0000&style=flat&message=74"
# OpenStreetMap
