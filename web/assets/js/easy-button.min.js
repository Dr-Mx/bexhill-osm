...
return new(Function.prototype.bind.apply(L.Control.EasyBar,args));};L.Control.EasyButton=L.Control.extend({options:{position:'topleft',id:null,type:'replace',states:[],leafletClasses:true},initialize:function(icon,onClick,title,id){this.options.states=[];if(id!=null){this.options.id=id;}
